  ...
  return (
    <div className="pt-22 mb-6 min-h-[70vh]">
      <div>
        <div>
          <img
            className="w-full h-42 md:h-64 object-cover rounded-xl"
            src={singleRestaurant?.coverImage}
            alt={singleRestaurant?.restaurantName || 'Restaurant'}
          />
          <h3 className="text-xl font-bold ml-1 mt-2">
          ...
          <div>
            ...
            <p className="text-lg font-bold flex items-center mt-2 gap-2">
            ...
            <p className="mt-8 text-xl font-extrabold text-center sm:text-start">
              Available Menus: {singleRestaurant?.menus?.length || 0}
            </p>
          </div>

          {singleRestaurant?.menus && restaurantId && (
            <AvailableMenu
